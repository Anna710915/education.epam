...
import by.epam.connectiontask.mapper.impl.UserDiscountMapper;
...
public class UserDiscountDao extends AbstractDao<UserDiscount> {
    ...
    public List<UserDiscount> findAll() throws DaoException {
        ...
        try{
            ...
            while (resultSet.next()){
                CustomRowMapper<UserDiscount> rowMapper = new UserDiscountMapper();
                userDiscountList.add(rowMapper.mapRow(resultSet));
            }
    ...
    public UserDiscount findEntityById(long id) throws DaoException {
        ...
        try{
            ...
            if(resultSet.next()) {
                CustomRowMapper<UserDiscount> rowMapper = new UserDiscountMapper();
                userDiscount = rowMapper.mapRow(resultSet);
            }
