package by.epam.connectiontask.dao.impl;

import by.epam.connectiontask.dao.UserDao;
import by.epam.connectiontask.entity.User;
import by.epam.connectiontask.exception.DaoException;
import by.epam.connectiontask.mapper.impl.UserMapper;
...
import static by.epam.connectiontask.mapper.impl.UserMapper.PASSWORD;
import static by.epam.connectiontask.mapper.impl.UserMapper.USER_STATE;
...
public class UserDaoImpl extends AbstractDao<User> implements UserDao {
    ...
    private static final String SQL_UPDATE_USER = """
            ...
            phone = (?), birthday = (?), registration_date = (?), discount_id = (?), state_id = (?), role_id = (?) 
            WHERE user_id = (?)""";
    ...
    private static final String SQL_SELECT_USER_BY_LOGIN = """
            ...
            registration_date, personal_discounts.discount, state, role_name FROM users
    ...
    public List<User> findAll() throws DaoException {
        ...
        try{
            ...
            while (resultSet.next()){
                userList.add(new UserMapper().mapRow(resultSet));
            }
    ...
    public boolean create(User entity) throws DaoException {
        ...
        try{
            ...
            statement.setLong(10, entity.getState().getStateId());
            statement.setLong(11, entity.getRole().getRoleId());
    ...
    public Optional<User> findUserByLogin(String login) throws DaoException {
        ...
        try{
            ...
            ResultSet resultSet = statement.executeQuery();
            if (resultSet.next()){
                user = Optional.of(new UserMapper().mapRow(resultSet));
            }
        } catch (SQLException e) {
            throw new DaoException(e);
        }finally {
