...
import by.epam.connectiontask.dao.OrderDao;
...
import by.epam.connectiontask.mapper.impl.OrderMapper;
...
import static by.epam.connectiontask.mapper.impl.OrderMapper.ORDER_STATE;
    ...
    public List<Order> findAll() throws DaoException {
        ...
        try {
            ...
            while (resultSet.next()){
                orderList.add(new OrderMapper().mapRow(resultSet));
            }
