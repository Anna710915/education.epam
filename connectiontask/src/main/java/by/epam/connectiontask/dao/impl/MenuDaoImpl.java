...
import by.epam.connectiontask.dao.MenuDao;
...
import by.epam.connectiontask.mapper.impl.MenuMapper;

import java.sql.*;
import java.util.*;

import static by.epam.connectiontask.mapper.impl.MenuMapper.DISH_NUMBER;
import static by.epam.connectiontask.mapper.impl.MenuMapper.PICTURE_PATH;
...
public class MenuDaoImpl extends AbstractDao<Menu> implements MenuDao {
    ...
    public List<Menu> findAll() throws DaoException {
        ...
        try{
            ...
            while (resultSet.next()){
                menuList.add(new MenuMapper().mapRow(resultSet));
            }
    ...
    public Menu findEntityById(long id) throws DaoException {
        ...
        try{
            ...
            ResultSet resultSet = statement.executeQuery();
            if (resultSet.next()){
                menu = new MenuMapper().mapRow(resultSet);
            }
        } catch (SQLException e) {
            throw new DaoException(e);
        } finally {
    ...
    public Optional<Menu> findFoodByName(String name) throws DaoException {
        ...
        try{
            ...
            ResultSet resultSet = statement.executeQuery();
            if(resultSet.next()){
                food = Optional.of(new MenuMapper().mapRow(resultSet));
            }
        } catch (SQLException e) {
            throw new DaoException(e);
        } finally {
    ...
    public Map<Menu, Integer> findAllOrderFood(Order order) throws DaoException {
        ...
        try{
            ...
            ResultSet resultSet = statement.executeQuery();
            while (resultSet.next()){
                orderMenu.put(new MenuMapper().mapRow(resultSet),resultSet.getInt(DISH_NUMBER));
            }
        } catch (SQLException e) {
            throw new DaoException(e);
        } finally {
