...
<head>
    ...
    <title><fmt:message key="profile.discount"/> </title>
</head>
<body>
<div class="page">
    <header>
    ...
    <div>
        <p>
            Ваша скидка равна 5%
            скидка распространяется на все товары GoodCafe, кроме производителей с предельными скидками;
            ...
            За последние двенадцать месяцев Вам было доставлено 16 товаров.
        </p>
    </div>
